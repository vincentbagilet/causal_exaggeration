...
```{r setup_DID, include=FALSE, results='hide', warning=FALSE}
library(knitr)
...
```{r packages_DID, message=FALSE, warning=FALSE, include=FALSE}
library(tidyverse) 
library(knitr) 
library(fixest)
...
I get "inspiration" for the values of parameters from [Lavaine and Neidell (2017)](https://www.journals.uchicago.edu/doi/full/10.1086/691554).
...
I then run the simulations by looping our `compute_sim_DID` function on `param_DID` using the `purrr` package (`pmap_dfr` function).
