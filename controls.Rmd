...
sim_controls <- sim_controls |> 
  mutate(ratio_gamma_delta = round(gamma^2/kappa, 1))
...
```{r graph_distrib_cntrols, code_folding='Show the code used to generate the graph', fig.asp=1}
sim_controls %>% 
  # filter(model == "ctrl") |> 
  mutate(
  ...
  ungroup() %>%
  ggplot(aes(x = ratio_exagg, fill = signif)) + 
  ...
  labs(
    ...
    fill = "",
    title = "Distribution of estimates for different gamma/delta",
