		...
		\subsection{Naive regression (OVB)}
			...
			\subsubsection{Asymptotic distribution}	
				...
				\begin{align*}
					...
					\sigma_{\textsc{ovb}} & = \dfrac{\delta^{2}\sigma_{w}^{2} + \sigma_{u}^{2}}{n \ \sigma_{x}^{2}}
				\end{align*}				
			...
			Now, note that we have :
				~
				\begin{align*}
					\sigma_x^2 & =  \text{Var}(x) = \text{Var}(z_i + \gamma w_i + \epsilon_i) \\
						& = \text{Var}(z_i) + \gamma^{2} \text{Var}(w_i) + \text{Var}(\epsilon_{i}) + 2 \gamma \underbrace{\text{cov}(z_i, w_i)}_{0} + 2 \gamma \underbrace{\text{cov}(\epsilon_i, w_i)}_{0} + 2  \underbrace{\text{cov}(\epsilon_i, z_i)}_{0}\\
						& = \sigma_{z}^{2} + \gamma^{2} \sigma_{w}^{2} + \sigma_{\epsilon}^{2}
				\end{align*}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
		...
		\subsection{Instrumental Variable}
			...
			Now, $\mathbb{E}[\text{z}_{i}\text{z}_{i}'w_{i}^{2}]  = \mathbb{E}[\text{z}_{i}\text{z}_{i}'\mathbb{E}[w_{i}^{2} | \text{z}_{i}]] = \mathbb{E}[\text{z}_{i}\text{z}_{i}'\mathbb{E}[w_{i}^{2}]] = \sigma_{w}^{2}\mathbb{E}[\text{z}_{i}\text{z}_{i}']$ and similarly, $\mathbb{E}[\text{z}_{i}\text{z}_{i}'u_{i}^{2}]  =  \sigma_{u}^{2}\mathbb{E}[\text{z}_{i}\text{z}_{i}']$ since 
