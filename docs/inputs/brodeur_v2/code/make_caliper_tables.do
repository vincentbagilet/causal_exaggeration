...
esttab using /results/table_cal_`depvar'_`weight2'.tex, margin ///
keep(DID IV RDD top5 2018.year experience_avg experience_avg_sq share_top_authors share_top_phd) label  stats(N Window, fmt(%9.0fc) labels("Observations")) ///
...
esttab using /results/table_cal_sign_5pct_aw_expanded.tex, margin ///
...
esttab using /results/table_cal_`depvar'_`weight2'_logit.tex, margin ///
keep(DID IV RDD top5 2018.year experience_avg experience_avg_sq share_top_authors share_top_phd) label  stats(N Window, fmt(%9.0fc) labels("Observations")) ///
mtitles() nomtitles nostar ///
 compress se(3) b(3) replace nogaps noomitted ///
indicate( ///
...
esttab using /results/table_cal_sign_5pct_aw_bootstrap.tex, margin ///
keep(DID IV RDD top5 2018.year experience_avg experience_avg_sq share_top_authors share_top_phd) label  stats(N Window, fmt(%9.0fc) labels("Observations")) ///
mtitles() nomtitles nostar ///
 compress se(3) b(3) replace nogaps noomitted ///
indicate( ///
...
esttab using /results/table_cal_sign_5pct_ambig.tex, margin ///
keep(DID IV RDD top5 2018.year experience_avg experience_avg_sq share_top_authors share_top_phd) label  stats(N Window, fmt(%9.0fc) labels("Observations")) ///
mtitles() nomtitles nostar ///
 compress se(3) b(3) replace nogaps noomitted ///
indicate( ///
...
esttab using /results/table_cal_sign_5pct_aw_single_method_articles.tex, margin ///
keep(DID IV RDD top5 2018.year experience_avg experience_avg_sq share_top_authors share_top_phd) label  stats(N Window, fmt(%9.0fc) labels("Observations")) ///
mtitles() nomtitles nostar ///
 compress se(3) b(3) replace nogaps noomitted ///
indicate( ///
...
esttab using /results/table_cal_`depvar'_`weight2'_1sttable.tex, margin ///
keep(DID IV RDD top5 2018.year experience_avg experience_avg_sq share_top_authors share_top_phd) label  stats(N Window, fmt(%9.0fc) labels("Observations")) ///
mtitles() nomtitles nostar ///
 compress se(3) b(3) replace nogaps noomitted ///
indicate( ///
...
esttab using /results/table_`depvar'_`weight2'.tex, margin ///
keep(DID IV RDD top5 2018.year experience_avg experience_avg_sq share_top_authors share_top_phd) label  stats(N, fmt(%9.0fc) labels("Observations")) ///
mtitles() nomtitles nostar ///
 compress se(3) b(3) replace nogaps noomitted ///
indicate( ///
...
esttab using /results/table_cal_`depvar'_`weight2'_windows.tex, margin ///
keep(DID IV RDD  2018.year experience_avg experience_avg_sq share_top_authors share_top_phd) label  stats(N Window, fmt(%9.0fc) labels("Observations")) ///
mtitles() nomtitles nostar ///
 compress se(3) b(3) replace nogaps noomitted ///
indicate( ///
...
esttab using /results/table_cal_`depvar'_`weight2'_windows_JFE.tex, margin ///
keep(DID IV RDD  2018.year experience_avg experience_avg_sq share_top_authors share_top_phd) label  stats(N Window, fmt(%9.0fc) labels("Observations")) ///
mtitles() nomtitles nostar ///
 compress se(3) b(3) replace nogaps noomitted ///
indicate( ///
...
esttab using /results/table_cal_`depvar'_`weight2'_DID_GRAPH.tex, margin ///
keep(DID_graph IV RDD RCT top5 2018.year experience_avg experience_avg_sq share_top_authors share_top_phd) label  stats(N Window, fmt(%9.0fc) labels("Observations")) ///
mtitles() nomtitles nostar ///
 compress se(3) b(3) replace nogaps noomitted ///
indicate( ///
...
esttab using /results/table_cal_`depvar'_`weight2'_FIELD.tex, margin ///
...
esttab using /results/table_cal_sign_5pct_aw_wp.tex,  ///
stats(N N_clust Window, fmt(%9.0fc) labels("Test Statistics" "Articles")) ///
label  mtitles(ALL DID IV RCT RDD)  nostar compress se(3) b(3) replace nogaps noomitted ///
nonotes
...
esttab using /results/table_has_wp.tex, margin ///
keep(DID IV RDD   top5 2018.year experience_avg experience_avg_sq share_top_authors share_top_phd) label  stats(N, fmt(%9.0fc) labels("Articles")) ///
mtitles() nomtitles nostar ///
 compress se(3) b(3) replace nogaps noomitted ///
indicate( ///
