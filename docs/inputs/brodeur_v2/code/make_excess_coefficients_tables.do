...
export excel titles fit_* using "/results/excess_fit" if _n <= 5, sheetmodify cell(A1) firstrow(variables) 
...
export excel titles fit_* using "/results/excess_fit" if _n <= 5, sheetmodify cell(A6) firstrow(variables) 
beep
...
export excel titles fit_* using "/results/excess_fit" if _n <= 5, sheetmodify cell(A11) firstrow(variables) 
beep
...
export excel titles fit_* using "/results/excess_fit" if _n <= 5, sheetmodify cell(A16) firstrow(variables) 
...
if "`panel'"=="1" {
export excel titles excess* using "/results/table_excess.xls" if _n <= `counter', sheetmodify cell(A1) firstrow(variables) 

}
if "`panel'"=="2" {
export excel titles excess* using "/results/table_excess.xls" if _n <= `counter', sheetmodify cell(A11) firstrow(variables) 

}
if "`panel'"=="3" {
export excel titles excess* using "/results/table_excess.xls" if _n <= `counter', sheetmodify cell(A21) firstrow(variables) 

}
if "`panel'"=="4" {
export excel titles excess* using "/results/table_excess.xls" if _n <= `counter', sheetmodify cell(A31) firstrow(variables) 

}
if "`panel'"=="5" {
export excel titles excess* using "/results/table_excess.xls" if _n <= `counter', sheetmodify cell(A41) firstrow(variables) 
