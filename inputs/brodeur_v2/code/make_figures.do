...
graph export /results/figure1a.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph temp4.gph, ycommon scheme(s1mono) xcommon xsize(4) ysize(3)
graph export /results/figurea3.eps, replace 
...
graph export /results/figurea4.eps, replace 
...
graph export /results/figurea5.eps, replace 
...
graph export /results/figurea6.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph temp4.gph, ycommon scheme(s1mono) xcommon
graph export /results/figurea7.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph temp4.gph, ycommon scheme(s1mono) xcommon
graph export /results/figurea8.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph temp4.gph, ycommon scheme(s1mono) xcommon
graph export /results/figurea9.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph temp4.gph, ycommon scheme(s1mono) xcommon
graph export /results/figurea10.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph temp4.gph, ycommon scheme(s1mono) xcommon
graph export /results/figurea11.eps, replace 
...
graph export /results/figurea12.eps, replace  
...
histogram t if t <= 10 & method=="RDD", title("RDD") saving(temp4, replace) width(0.1) start(0) fcolor(gs10) lcolor(gs10) kdensity kdenopts(width(0.1)) xtitle(z-statistic) xline(1.65 1.96 2.58, lwidth(thin)) xlabel(0(1)10) legend(off) scheme(s1mono)
graph combine temp1.gph temp2.gph temp3.gph temp4.gph, ycommon scheme(s1mono) xcommon xsize(4) ysize(3)
graph export /results/figurea13.eps, replace  
...
graph export /results/figurea14`panel'.eps, replace 
...
graph export /results/figurea15.eps, replace 
...
graph combine temp1.gph temp2.gph , ycommon scheme(s1mono) xcommon  xsize(4) ysize(1.5)
graph export /results/figurea16.eps, replace 
...
graph export /results/figurea17.eps, replace 
...
graph combine temp1.gph temp2.gph , ycommon scheme(s1mono) xcommon xsize(2) ysize(1)
graph export /results/figurea18.eps, replace 
...
graph combine temp1.gph temp2.gph , ycommon scheme(s1mono) xcommon  xsize(4) ysize(1.5)
graph export /results/figurea19.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph temp4.gph, ycommon scheme(s1mono) xcommon
graph export /results/figurea20.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph temp4.gph, ycommon scheme(s1mono) xcommon
graph export /results/figurea21.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph temp4.gph, ycommon scheme(s1mono) xcommon
graph export /results/figurea22.eps, replace 
...
if "`threshold'" == "1.65" {
graph export /results/figurea23.eps, replace
}

if "`threshold'" == "1.96" {
graph export /results/figurea24.eps, replace
}

if "`threshold'" == "2.58" {
graph export /results/figurea25.eps, replace
}
...
graph export /results/figurea26a.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph , ycommon scheme(s1mono) xcommon xsize(1) ysize(1) caption("") scale(0.75) rows(2)
graph export /results/figurea26b.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph , ycommon scheme(s1mono) xcommon xsize(1) ysize(1) caption("") scale(0.75) rows(2)
graph export /results/figurea27a.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph , ycommon scheme(s1mono) xcommon xsize(1) ysize(1) caption("") scale(0.75) rows(2)
graph export /results/figurea27b.eps, replace 
...
graph combine temp1.gph temp2.gph temp3.gph temp4.gph, ycommon scheme(s1mono) xcommon xsize(4) ysize(3)
graph export /results/figurea28.eps, replace 
