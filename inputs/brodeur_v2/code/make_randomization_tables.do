...
esttab using /results/table_above_below_`threshold2'_compared_to_half, tex replace ///
	 main(mean %6.3f) mtitles  nogaps compress noobs nonotes  label
...
esttab using /results/table_above_prop_`threshold2', tex replace ///
	 main(mean %9.4f) mtitles  nogaps compress noobs nonotes  label
...
esttab using /results/table_above_below_`threshold2'_compared_to_half_aw, tex replace ///
	 main(mean %8.3f) mtitles  nogaps compress noobs nonotes  label
...
dataout, save("/results/table_above_below_F") tex replace 
