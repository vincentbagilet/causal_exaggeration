...
esttab using /results/table2, tex replace cells(mean(fmt(2)) sd(par fmt(2)) )  mtitles
...
esttab ,cells(mean(fmt(2)) sd(par fmt(2)) )  mtitles nonumbers nonotes
esttab using /results/tablea2  , tex replace cells(mean(fmt(2)) sd(par fmt(2)) )  mtitles
restore
...
esttab ,cells(mean(fmt(2)) sd(par fmt(2)) )  mtitles nonumbers nonotes
esttab using /results/tablea34  , tex replace cells(mean(fmt(2)) sd(par fmt(2)) )  mtitles
restore