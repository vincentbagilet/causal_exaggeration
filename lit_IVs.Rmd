...
In this document, I therefore leverage the reviews by @young_consistency_2022 and @lalHow2024 to explore potential exaggeration of the IVs in the economics and political science literature.
...
To compute these analyses, I use the standard errors reported by the authors of each analysis, even though some of these are likely understated, as underlined by @young_consistency_2022 and @lalHow2024. This approach is therefore conservative. 

## IVs in the Economics Literature

I first compute the aforementioned measures for the economics literature, leveraging data gathered in @young_consistency_2022. This paper analyzes 30 papers published in journals of the American Economics Association published through July 2016, for a total of 1309 2SLS regressions. To carry out his analysis, Young retrieved all these estimates and associated standard errors. 
...
I then run similar power calculations as for @young_consistency_2022, computing what would be the statistical power and exaggeration if the true effect was equal to the OLS point estimate. Re
