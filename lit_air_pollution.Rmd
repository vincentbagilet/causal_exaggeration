...
```{r packages_pollution, message=FALSE, warning=FALSE, code_folding='Show the packages used in this document'}
library(tidyverse) 
library(knitr) 
...
First, I load the data set containing results of the meta-analysis. I then print the whole table:

```{r load_data, code_folding=TRUE, layout="l-body-outset"}
data_lit_review <-
  readRDS(here(
    "inputs",
    "air_pollution",
...
## Compare to the literature review in @shah_short_2015
...
### True effect as in @shah_short_2015

First, I define the true effect based on a meta-analysis carried out in @shah_short_2015. They find the following impact of standardized increments in pollutant concentration on relative risk for mortality and hospital admissions (CI = 95% CIs):
...
## Example of @he_straw_2020

I then study the case of @he_straw_2020. They find that " a 10 μg/m3 increase in PM2.5 increases mortality by 3.25%" (se 1.43%). Their OLS results suggest a 0.32% increase (sd 0.23%). 
...
I then plot the distribution of the OLS estimator, assuming that the point estimate found in @he_straw_2020 is at the center of this distribution. I also plot the distribution of the 2SLS estimator of @he_straw_2020 that would be obtained if the IV was centered on the true effect (as defined in @shah_short_2015). The standard deviation of this distribution is equal to the standard error of the 2SLS estimator of @he_straw_2020.
