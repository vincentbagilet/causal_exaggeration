...
\section{Simulations} \label{simulations}
    ...
    \subsection{Matching}
        ...
        \begin{figure}[!h] 
			...
			\label{dag_matching}
			 \centering\includegraphics[width=0.5\linewidth]{pictures/dag_matching.png}
    ...
    \subsection{Regression Discontinuity Design}
        ...
        \begin{figure}[!h] 
				...
				\label{graph_rdd}
				\centering\includegraphics[width=0.7\linewidth]{pictures/dag_rdd.png}
    ...
    \subsection{Instrumental Variable Strategy}
        ...
        \begin{figure}[!h] 
				...
				\label{graph_iv}
				\centering\includegraphics[width=0.8\linewidth]{pictures/dag_iv.png}
		\end{figure} 
