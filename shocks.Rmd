...
- Treatment is constant in time and homogeneous across zip codes. In this case, the two ways fixed effect estimation should yield a correct estimate of the ATET (as discussed in @de_chaisemartin_two-way_2022 for instance)
...
- **Treatment effect size** A usual treatment effect size in published studies is a change of about 1 to 3% in birthweight (*eg* in @currie_environmental_2015). I thus consider a 2% effect size and set $\beta_1 = 3228 \times 0.02 \simeq 65$
...
We calibrated our simulations to emulate a typical study from this literature. To further check that the results are realistic, we compare the average Signal-to-Noise Ratio (SNR) of our regressions to the range of SNR of existing studies investigating similar questions. @lavaine_energy_2017 find SNRs in the range 0.4 to 2.3 in their table 3 and 4. @currie_environmental_2015 find SNRs in the range 0.5 to 4 (both in table 6 but SNRs in this range in table 4 and 5 as well).
