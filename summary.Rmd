...
I updated my working paper arguing that causal inference methods can produce inflated published estimates.
...
I built fake data MC simulations to illustrate this.
...
I also developed a R package, ididvar, that provides tools to easily identify the identifying variation in a regression: [vincentbagilet.github.io/ididvar/](vincentbagilet.github.io/ididvar/)

The following vignette introduces it in details: [vincentbagilet.github.io/causal_exaggeration/ididvar.html](vincentbagilet.github.io/causal_exaggeration/ididvar.html)

#### Tweet 10/N

It computes identification weights as the leverage of each observation but after having partialled out the controls. 

Some observations, whose treatment status is well explained by controls and fixed effects do not contribute to identification.
...
knitr::include_graphics("images/summary/drowning.jpg")
```
